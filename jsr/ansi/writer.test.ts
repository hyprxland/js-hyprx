...
import { DefaultAnsiWriter } from "./writer.ts";
import { apply, bgBlue, bold, green, rgb24 } from "./styles.ts";
...
export class AnsiMemoryWriter extends DefaultAnsiWriter {
    ...
    override write(message?: string, ...args: unknown[]): this {
    ...
    override writeLine(message?: string, ...args: unknown[]): this {
        switch (arguments.length) {
            case 0:
