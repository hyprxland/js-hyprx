...
/**
 * Check if changing text color is enabled.
 * Default is determined by AnsiSettings.
 *
 ...
 */
export declare function apply(str: string, ...styles: ((str: string) => string)[]): string;
/**
 ...
 */
export declare function rgb24To8(str: string, color: number | Rgb): string;
/**
