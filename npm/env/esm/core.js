...
import { expand as substitute } from "./expand.js";
import { BROWSER, globals, WINDOWS } from "./globals.js";
...
if (globals.Deno) {
  proxy = new Proxy({}, {
    ...
    set(_target, name, value) {
      ...
      globals.Deno.env.set(name, value);
      return true;
    },
    ...
    has(_target, name) {
      ...
      return globals.Deno.env.get(name) !== undefined;
    },
    ownKeys(_target) {
    ...
    getOwnPropertyDescriptor(_target, name) {
      return {
        value: globals.Deno.env.get(name),
        writable: true,
        enumerable: true,
        configurable: true,
      };
  ...
  proxy = new Proxy({}, {
    ...
    set(_target, name, value) {
      ...
      globals.process.env[name] = value;
      return true;
    },
    deleteProperty(_target, name) {
      if (typeof name !== "string" || name === "") {
    ...
    has(_target, name) {
      ...
      return globals.process.env[name] !== undefined;
    },
    ownKeys(_target) {
    ...
    getOwnPropertyDescriptor(_target, name) {
      return {
        value: globals.process.env[name],
        writable: true,
        enumerable: true,
        configurable: true,
      };
